...
//$response = file_get_contents("http://ie.gobland.fr/IE_ClanCavernes.php?id=".$id."&passwd=".$passwd);
echo file_get_contents("http://ie.gobland.fr/IE_ClanCavernes.php?id=".$_GET['id']."&passwd=".$_GET['key']);
exit();
